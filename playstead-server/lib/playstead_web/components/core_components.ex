defmodule PlaysteadWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: PlaysteadWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlaysteadWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlaysteadWeb.Gettext, "errors", msg, opts)
    end
  end
