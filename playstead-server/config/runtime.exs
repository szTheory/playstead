...
#
#     PHX_SERVER=true bin/playstead start
#
  ...
  config :playstead, PlaysteadWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/playstead_web/router\.ex$"E,
        ~r"lib/playstead_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  # There is deliberately no mailer configuration here (D-02): no code path
  # anywhere in this application sends or attempts to send email. See
  # test/playstead_web/no_mailer_test.exs for the standing regression guard.
end
