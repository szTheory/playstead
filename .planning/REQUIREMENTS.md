...
- [ ] **PROT-01**: An authenticated owner can approve a Mac device-pairing request and the Mac client stores the resulting scoped credential in Keychain. (Phase 04.5: client ceremony shipped; live-server proof registered but not yet executed against a real server — see 04.5-01-SUMMARY.md.)
...
| PROT-01 | Phase 1 / 04.5 | In Progress (client shipped, live-server proof unexecuted) |
